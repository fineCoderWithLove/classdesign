  ...
  <div class="login">
    ...
    <div class="logon">
      <div :class="overlaylong">
        ...
        <el-form :model="loginForm" status-icon :rules="rules1" ref="loginForm" style="text-align: center">
          <div class="overlaylong-Signin" v-if="disfiex == 0">
            <h2 class="overlaylongH2">登录</h2>
            <el-form-item prop="id">
              <el-input v-model="loginForm.id" autocomplete="off" placeholder="请输入学号/教师编号/管理员编号" clearable></el-input>
            </el-form-item>
            ...
            <el-form-item>
              <el-button style="width:145px" type="primary" @click="submitForm('loginForm')" round
                :disabled="ifDisabled">登录</el-button>
        ...
        <el-form :model="registerForm" status-icon :rules="rules2" ref="registerForm">
          <div class="overlaylong-Signup" v-if="disfiex == 1">
            ...
            <el-form-item prop="checkPwd">
              <el-input type="password" v-model="registerForm.checkPwd" autocomplete="off" placeholder="请再次输入相同密码"
                clearable></el-input>
            </el-form-item>
...
export default {
  ...
  methods: {
    submitForm(loginForm) {
      this.$axios.get("/login?number=" + this.loginForm.id + "&password=" + this.loginForm.password).then(response => {
        console.log(response);
